    ...
    return (
        <div className="bg-transparent shadow-[6px_6px_14px_rgba(0,0,0,0.2),-8px_-8px_18px_rgba(255,255,255,0.55)] rounded-xl p-2 min-h-[380px]">
            <div className="flex flex-col ">
                ...
                <p className="px-4 ">Worked as a Key UI developer for this product. This product was delivered to an Oil and Gas Company. An intuitive application which would unify information and integrate business operations.</p>
